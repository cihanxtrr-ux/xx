                            ...
                            >
                              ...
                              {applicantApplied ? (
                                ...
                                <form onSubmit={handleApplyAction} className="space-y-3">
                                  ...
                                  <div className="pt-2">
                                    <MathCaptchaCheckbox onVerified={setCaptchaVerified} className="max-w-xs" />
                                  </div>
                                  ...
                                  <div className="flex flex-col sm:flex-row items-center justify-between gap-3 pt-2">
                                    ...
                                    <button
                                      ...
                                      className="py-2.5 px-6 rounded-lg bg-gray-900 text-white font-bold hover:bg-gray-800 transition text-xs uppercase flex items-center gap-1.5 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
                                    >
