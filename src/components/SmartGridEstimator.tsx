...
import MathCaptchaCheckbox from './MathCaptchaCheckbox';
import { 
  Building, 
  Settings, 
  Sliders, 
                ...
                <form onSubmit={handleInquiryAction} className="space-y-3">
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    <input
                      ...
                      className="bg-white/5 border border-white/10 rounded-lg px-3 py-2 text-xs focus:ring-1 focus:ring-[#00FF00] outline-none text-white focus:bg-white/10 transition w-full"
                    />
                    <input
                      required
                      type="email"
                  ...
                  <button
                    type="submit"
                    disabled={!verified}
                    className="w-full py-3 px-4 rounded-xl bg-[#00FF00] text-gray-900 font-bold hover:bg-[#00E000] active:scale-98 transition flex items-center justify-center gap-2 text-sm uppercase cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
                  >
