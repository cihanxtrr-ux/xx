...
export const translations: Record<'en' | 'tr', TranslationDictionary> = {
  en: {
    ...
    products: {
      ...
      p6Name: 'XE-MCC 480V Heavy Motor Control Center',
      p6Desc: 'Digital motor control enclosure equipped with smart electronic overload monitors, PLC link gateways, and high-tolerance contactors for massive pumping & fan systems.',
      p7Name: 'XE-UPS 1200A Modular Critical UPS',
      p7Desc: 'Three-phase double conversion critical UPS array. Fully hot-swappable containerized power modules with 99% operational efficiency and integrated smart telemetry loop.',
      p8Name: 'XE-PQA Class-A Power Quality Analyzer',
      p8Desc: 'Continuous grid diagnostic panel tracking harmonics up to 63rd order, transient spikes, and power-factor shifts. Connected to live cloud analytics SCADA integrations.',
      p9Name: 'XE-PTB Compact 8-Port Push-In Splicer',
      p9Desc: 'High-density push-in conductor terminal block with a transparent housing for quick visual inspection of connections, optimized for heavy control panel wiring.',
    },
    blog: {
  ...
  tr: {
    ...
    products: {
      ...
      p6Name: 'XE-MCC 480V Ağır Motor Kontrol Merkezi',
      p6Desc: 'Dev pompa ve fan sistemleri için tasarlanmış akıllı elektronik aşırı yük izleyiciler, PLC bağlantı ağ geçitleri ve yüksek toleranslı kontaktörlerle donatılmış dijital motor kontrol hücresi.',
      p7Name: 'XE-UPS 1200A Modüler Kritik UPS Sistemi',
      p7Desc: 'Üç fazlı çift çevrim kritik kesintisiz güç kaynağı (UPS) dizisi. %99 çalışma verimliliği ve entegre akıllı telemetri döngüsüne sahip, tamamen çalışırken değiştirilebilir (hot-swap) güç modülleri.',
      p8Name: 'XE-PQA Sınıf-A Güç Kalitesi Analizörü',
      p8Desc: '63. dereceye kadar harmonikleri, ani voltaj sıçramalarını ve kosinüs pi güç faktörü kaymalarını izleyen sürekli şebeke tanı paneli. Canlı bulut analiz SCADA entegrasyonlarına bağlıdır.',
      p9Name: 'XE-PTB Kompakt 8 Portlu Push-In Klemens',
      p9Desc: 'Sıkışık kontrol panoları ve pano içi kablolar için optimize edilmiş, bağlantıların şeffaf gövde üzerinden kolayca gözlemlenebildiği 8 hatlı hızlı kablo ek klemensi.',
    },
    blog: {
