...
import { ShieldCheck, ArrowUpRight, Check, Zap, Eye, RefreshCw, Cpu, Server, ChevronLeft, ChevronRight, AlertTriangle } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="relative overflow-hidden rounded-3xl border border-amber-300/40 dark:border-amber-500/25 bg-amber-500/5 dark:bg-amber-500/5 p-5 md:p-6 flex flex-col md:flex-row items-start md:items-center gap-4 text-left shadow-sm animate-pulse"
      >
