          ...
          <AnimatePresence mode="wait">
            {submitted ? (
              ...
              <motion.form key="contact-form" onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="pt-2">
                  <MathCaptchaCheckbox onVerified={setVerified} className="mb-4" />
                </div>

                <button
                  type="submit"
                  disabled={!verified}
                  className="w-full py-3 px-4 rounded-xl bg-gray-950 dark:bg-[#00FF00] dark:text-gray-950 text-white font-extrabold text-xs transition uppercase flex items-center justify-center gap-2 hover:bg-gray-800 dark:hover:bg-[#00D000] cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
                >
